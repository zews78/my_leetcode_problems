<h2><a href="https://leetcode.com/problems/make-array-non-decreasing">Make Array Non-decreasing</a></h2> <img src='https://img.shields.io/badge/Difficulty-Medium-orange' alt='Difficulty: Medium' /><hr><p>You are given an integer array <code>nums</code>. In one operation, you can select a subarray and replace it with a single element equal to its <strong>maximum</strong> value.</p>
